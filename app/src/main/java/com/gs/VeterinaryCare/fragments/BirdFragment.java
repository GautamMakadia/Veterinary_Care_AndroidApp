...
public class BirdFragment extends Fragment {
    ...
    AnimalCardAdapter birdCardAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FirebaseRecyclerOptions<AnimalsData> options =
                new FirebaseRecyclerOptions.Builder<AnimalsData>()
                        ...
                        .build();
        birdCardAdapter = new AnimalCardAdapter(options);
        birdCardAdapter.startListening();

        View view = inflater.inflate(R.layout.fragment_bird,container,false);

        recyclerView = view.findViewById(R.id.birdRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(birdCardAdapter);
